...
class RGBTTinyDataset(BaseDetDataset):
    """Dataset for RGBT-Tiny."""

    METAINFO = {
        'classes':
        ('ship', 'car', 'cyclist', 'pedestrian', 'bus', 'drone', 'plane'), # 7
    ...
    def load_data_list(self) -> List[dict]:
        ...
        """  # noqa: E501
        # rgb "id": 20180000001 / "file_name": "DJI_0028_3/00/00000.jpg"
        # ir  "id": 20180046702 / "file_name": "DJI_0028_3/01/00000.jpg"
        ...
        for img_id in img_ids:
            ...
            assert raw_img_info['file_name'].replace('/00/', '/01/') == ir_raw_img_info['file_name']
