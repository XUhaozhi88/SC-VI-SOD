...
#     coco_true = COCO(annotation_file='E:/Files/Datasets/RGBT-Tiny/annotations_coco/instances_00_test2017_realcoco.json')
#     # coco_true = COCO(annotation_file='E:/Files/Datasets/RGBT-Tiny/annotations_coco/instances_00_test2017_refine_realcoco.json')
#     coco_pre=coco_true.loadRes('runs/detect/yolo12x/val/predictions.json')
#     # coco_pre=coco_true.loadRes('runs/detect/yolo12x/val/predictions.json')
#     # coco_pre=coco_true.loadRes('D:/Files/Code/Python/ultralytics-v8384/runs/detect/val/predictions_cat.json')
