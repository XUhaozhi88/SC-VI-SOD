...
@MODELS.register_module()
class Co_DinoTransformerDecoder(DeformableDetrTransformerDecoder):

    def __init__(self, *args, **kwargs):
        super(Co_DinoTransformerDecoder, self).__init__(*args, **kwargs)
        self._init_layers()
...
@MODELS.register_module()
class Co_DetrTransformerEncoder(TransformerLayerSequence):
    ...
    def __init__(self,
                 *args,
                 ...
                 with_cp=-1,
                 **kwargs):
        super(Co_DetrTransformerEncoder, self).__init__(*args, **kwargs)
...
@MODELS.register_module()
class Co_DetrTransformerDecoderLayer(BaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(Co_DetrTransformerDecoderLayer, self).__init__(
            attn_cfgs=attn_cfgs,
