...
class _Gate(nn.Module):
    def __init__(self, num_gate):
        ...
        self.IA_fc11 = nn.Linear(in_features=16*20*6, out_features = 1000)# rgbt_tiny
        ...
        self.IA_fc13 = nn.Linear(in_features=100, out_features = self.num_gate) # 5
        ...
        self.IA_fc21 = nn.Linear(in_features=16*20*6, out_features = 1000)# rgbt_tiny
