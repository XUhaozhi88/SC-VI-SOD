...
from ..layers.transformer.dino_layers_fusion_20250510 import DinoTransformerEncoder_Parallel
from ..layers.transformer.dino_layers_fusion import DinoTransformerDecoder_New
from .dino import DINO
from .deformable_detr import DeformableDETR


@MODELS.register_module()
class DINO_Parallel(DINO):
    def __init__(self,
                 *args,
                 mod_list=["img", "ir_img"],
                 use_autocast=False,                 
    ...
    def pre_decoder(
        ...
        head_inputs_dict = dict(
            ...
            extra_enc_outputs=[dict(enc_outputs_class=ir_topk_score, enc_outputs_coord=ir_topk_coords)],
