...
class DualVit_New(BaseModule):
    ...
    def __init__(self,
        ...
        super(DualVit_New, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(DualVit_New, self).train(mode)
        self._freeze_stages()
