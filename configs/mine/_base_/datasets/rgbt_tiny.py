...
# mod_list = ["img",]
mod_list = ["img", "ir_img"]
img_shape = (1333, 800)  # (1333, 800), (512, 640)
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # ann_file=dict(
        #     img='annotations_coco/instances_00_test2017_0.005.json',
        #     ir_img='annotations_coco/instances_01_test2017_0.005.json'),        
        # ann_file=dict(
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'annotations_coco/instances_00_test2017_inf_ann.json',
    # ann_file=data_root + 'annotations_coco/instances_00_test2017_0.5.json',
    # ann_file=data_root + 'annotations_coco/instances_00_test2017_0.005.json',
