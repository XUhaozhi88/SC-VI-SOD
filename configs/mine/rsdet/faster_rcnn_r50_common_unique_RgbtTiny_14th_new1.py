...
model = dict(
    type='RSDet_14th',
     data_preprocessor=dict(
        ...
        # Dataset Mean: tensor([95.2600, 98.9528, 99.1682])
        # Dataset Std: tensor([63.7147, 66.3973, 69.5646])
        mean=[159.8808906080302, 162.22057018543336, 160.28301196773916],
        std=[56.96897676312916, 59.57937492901139, 63.11906486423505],
        # Dataset Mean: tensor([87.3441, 87.3441, 87.3441])
        # Dataset Std: tensor([53.9395, 53.9395, 53.9395])
