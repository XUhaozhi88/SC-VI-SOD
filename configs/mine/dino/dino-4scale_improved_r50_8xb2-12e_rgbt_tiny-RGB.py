_base_ = [
    '../_base_/datasets/rgbt_tiny-RGB_yolo.py', '../_base_/default_runtime.py'
]
model = dict(
    type='DINO',
...
#     backbone=dict(out_indices=(0, 1, 2, 3), frozen_stages=-1),
#     neck=dict(in_channels=[256, 512, 1024, 2048], num_outs=num_levels),
