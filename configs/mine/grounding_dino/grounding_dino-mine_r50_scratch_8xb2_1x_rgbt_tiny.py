...
model = dict(
    ...
    decoder=dict(
        ...
        layer_cfg=dict(
            ...
            # cross attention layer query to ir image
            cross_attn_ir_cfg=dict(embed_dims=256, num_heads=8, dropout=0.0),
            # cross attention layer query to rgb image
            cross_attn_cfg=dict(embed_dims=256, num_heads=8, num_levels=num_levels, dropout=0.0),
            ffn_cfg=dict(
                embed_dims=256, feedforward_channels=2048, ffn_drop=0.0)),
        post_norm_cfg=None),
