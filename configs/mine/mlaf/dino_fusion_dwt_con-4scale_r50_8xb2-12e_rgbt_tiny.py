...
model = dict(
    type='DINO_Fusion_DWT_Contrastive',
    ...
    data_preprocessor=dict(
        ...
        mean={
            ...
            "con_img": [123.675, 116.28, 103.53]
        },
        std={
            "img": [58.395, 57.12, 57.375], 
            "ir_img": [58.395, 57.12, 57.375],
            "con_img": [58.395, 57.12, 57.375]
        },
        # mean=[123.675, 116.28, 103.53],
        # std=[58.395, 57.12, 57.375],
        bgr_to_rgb=True,
        pad_size_divisor=128,
        # train_mod_list=["img", "ir_img"],
...
val_evaluator = dict(
    ...
    ann_file=_base_.data_root + 'annotations_coco/instances_00_test2017.json',
