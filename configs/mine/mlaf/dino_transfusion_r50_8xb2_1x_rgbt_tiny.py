...
model = dict(
    ...
    encoder=dict(
        ...
        # fusion_layer_cfg=dict(  # SingleScaleBiAttentionBlock
        #     v_dim=256, l_dim=256, embed_dim=1024, num_heads=4, init_values=1e-4),          
        # fusion_layer_cfg=dict(  # SingleScaleAttentionBlock
        #     master_dim=256, slave_dim=256, embed_dim=1024, num_heads=4, init_values=1e-4),   
        fusion_layer_cfg=dict(  # DeformableDetrTransformerCrossLayer
