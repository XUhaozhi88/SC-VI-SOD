...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='/workspace/mmdetection/best_coco_bbox_mAP_epoch_10.pth', prefix='backbone.'),
        ),
    neck=dict(
        type='ChannelMapper',
        ...
        num_outs=4,
        init_cfg=dict(type='Pretrained', checkpoint='/workspace/mmdetection/best_coco_bbox_mAP_epoch_10.pth', prefix='neck.'),
        ),
    encoder=dict(
        num_layers=6,
        layer_cfg=dict(
