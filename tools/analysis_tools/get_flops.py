...
def parse_args():
    ...
    # parser.add_argument('--config', default='/workspace/mmdetection/configs/mine/dino/dino_fusion_simple-4scale_r50_8xb2-12e_rgbt_tiny.py',
